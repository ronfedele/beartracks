...
export default function AdminStudentsPage() {
  ...
  async function openEdit(s?: any) {
    ...
    if (s) {
      ...
      setForm({ first_name:s.first_name, last_name:s.last_name, grade:s.grade?.toString()??'',
        student_id:s.student_id??'', room_id:s.room_id??'', no_roam:s.no_roam, watch_list:s.watch_list })
      const supabase = createClient()
  ...
  async function handleSave() {
    ...
    const payload = { first_name:form.first_name, last_name:form.last_name,
      ...
      room_id:form.room_id||null, no_roam:form.no_roam, watch_list:form.watch_list }
    let sid = editId
    if (editId) {
